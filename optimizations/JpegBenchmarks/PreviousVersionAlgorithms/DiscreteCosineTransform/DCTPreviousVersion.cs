using System;
using JpegBenchmarks.PreviousVersionAlgorithms.Utilities;

namespace JpegBenchmarks.PreviousVersionAlgorithms.DiscreteCosineTransform
{
    public static class DCTPreviousVersion
    {
